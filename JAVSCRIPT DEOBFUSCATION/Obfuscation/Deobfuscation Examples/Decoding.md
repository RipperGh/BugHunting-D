...
```
GhostRipper@htb[/htb]$ curl http:/SERVER_IP:PORT/serial.php -X POST -d "param1=sample"
...
```
GhostRipper@htb[/htb]$ echo https://www.hackthebox.eu/ | base64
...
```
GhostRipper@htb[/htb]$ echo aHR0cHM6Ly93d3cuaGFja3RoZWJveC5ldS8K | base64 -d
...
```
GhostRipper@htb[/htb]$ echo https://www.hackthebox.eu/ | xxd -p
...
```
GhostRipper@htb[/htb]$ echo 68747470733a2f2f7777772e6861636b746865626f782e65752f0a | xxd -p -r
...
```
GhostRipper@htb[/htb]$ echo https://www.hackthebox.eu/ | tr 'A-Za-z' 'N-ZA-Mn-za-m'
...
```
GhostRipper@htb[/htb]$ echo uggcf://jjj.unpxgurobk.rh/ | tr 'A-Za-z' 'N-ZA-Mn-za-m'
...
I was able to get base64 encoded , with using the first step. The issues I was dealing with was i wasn't able to find anything. I just realize that the way it was being read was the issues since it keep curling then doing my camnd to search /serial.php
